...
func request_Task_CompanyByIIN_0(ctx context.Context, marshaler runtime.Marshaler, client TaskClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Task_CompanyByIIN_0(ctx context.Context, marshaler runtime.Marshaler, server TaskServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CompanyByIINRequest
	var metadata runtime.ServerMetadata
...
func RegisterTaskHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TaskServer) error {
	...
	mux.Handle("GET", pattern_Task_CompanyByIIN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Task_CompanyByIIN_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Task_CompanyByIIN_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTaskHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TaskClient) error {
	...
	mux.Handle("GET", pattern_Task_CompanyByIIN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Task_CompanyByIIN_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Task_CompanyByIIN_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "companies", "inn"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Task_CompanyByIIN_0 = runtime.ForwardResponseMessage
)
